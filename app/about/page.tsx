    ...
    <div className="min-h-screen bg-background text-foreground py-24">
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6">Our Mission</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <Card className="p-8 border-border rounded-[2rem] bg-card">
          ...
          <Card className="p-8 border-border rounded-[2rem] bg-card">
            ...
            <h2 className="text-2xl font-black mb-4">Pure Performance</h2>
            <p className="text-muted-foreground font-medium">
